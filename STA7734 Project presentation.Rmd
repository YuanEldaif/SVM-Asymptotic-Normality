...
--
##There is a 1 in 8 chance she will develop breast cancer in the United States.

--
##The average 5-year survival rate for women with invasive breast cancer is 90%.
...
#Model: SVM
##Article : "Asymptotic normality of support vector machine variants and other regularized kernel methods" --Robert Hable

--
##SVM Estimator $$S_n: (\mathcal{X} \, X \, \mathcal{Y})^n \to H, \quad D_n \mapsto f_{L,D_n,\lambda_{D_n}}$$
...
---
class: bg-main1
###1) Show that $\sqrt{n}(\mathbb{P}_{D_n} - P)$ converges weakly to a Gaussian process

--
###2) The map $S: P \mapsto f_{L,P,\lambda}$ is suitably Hadamard-differentiable.

--
###(a) first order differentiable
###(b) second order differentiable

--
###3) Applying a functional delta-method, show asymptotic normality of $\lambda$,  $$\sqrt{n}(\lambda_{D_n} - \lambda_0) \xrightarrow{P} 0,$$ then the risk:    $$\sqrt{n}(\mathbb{R}_{L,P}(f_{L,D_n,\lambda_{D_n}}) - \mathbb{R}_{L,P}(f_{L,P,\lambda_0}))$$
...
#.yellow[Step 3]: Prove $\lambda$ is asymptotically normal so delta method can be applied
```{r, echo = FALSE, out.width = "100%", out.height = "100%"}
